...
public class SecretCmd implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        if (context.getSource().getEntity() != null) {
            ForgeMessageUtil.sendMessage(context.getSource(), Component.translatable(ForgeMessageUtil.format("secret_console_only"))
        ...
        plugin.getPlatform().executeAsync(() -> {
            ...
            try {
                ...
                ForgeMessageUtil.sendMessage(context.getSource(), Component.translatable(ForgeMessageUtil.format("secret_does_not_work"))
                        .setStyle(CmdUtil.ERROR_STYLE));
                return;
            }
            ...
            try {
                ...
                ForgeMessageUtil.sendMessage(context.getSource(), Component.translatable(ForgeMessageUtil.format("secret_cant_be_saved"))
                        .setStyle(CmdUtil.ERROR_STYLE));
            }

            ForgeMessageUtil.sendMessage(context.getSource(), Component.translatable(ForgeMessageUtil.format("secret_success",
