...
public class SecretCmd implements Command<CommandSource> {
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        if (context.getSource().getEntity() != null) {
            ForgeMessageUtil.sendMessage(context.getSource(), new StringTextComponent(ForgeMessageUtil.format("secret_console_only"))
        ...
        plugin.getPlatform().executeAsync(() -> {
            ...
            try {
                ...
                ForgeMessageUtil.sendMessage(context.getSource(), new StringTextComponent(ForgeMessageUtil.format("secret_does_not_work"))
                        .setStyle(CmdUtil.ERROR_STYLE));
                return;
            }
            ...
            try {
                ...
                ForgeMessageUtil.sendMessage(context.getSource(), new StringTextComponent(ForgeMessageUtil.format("secret_cant_be_saved"))
                        .setStyle(CmdUtil.ERROR_STYLE));
            }

            ForgeMessageUtil.sendMessage(context.getSource(), new StringTextComponent(ForgeMessageUtil.format("secret_success",
